...
public class BlockInit
{
    ...
    public static final DeferredHolder<Block, CampfireBlock> ACACIA_CAMPFIRE = BLOCKS.registerBlock("acacia_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> ACACIA_SOUL_CAMPFIRE = BLOCKS.registerBlock("acacia_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> BIRCH_CAMPFIRE = BLOCKS.registerBlock("birch_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> BIRCH_SOUL_CAMPFIRE = BLOCKS.registerBlock("birch_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> CRIMSON_CAMPFIRE = BLOCKS.registerBlock("crimson_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> CRIMSON_SOUL_CAMPFIRE = BLOCKS.registerBlock("crimson_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> DARK_OAK_CAMPFIRE = BLOCKS.registerBlock("dark_oak_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> DARK_OAK_SOUL_CAMPFIRE = BLOCKS.registerBlock("dark_oak_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> JUNGLE_CAMPFIRE = BLOCKS.registerBlock("jungle_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> JUNGLE_SOUL_CAMPFIRE = BLOCKS.registerBlock("jungle_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> MANGROVE_CAMPFIRE = BLOCKS.registerBlock("mangrove_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> OAK_CAMPFIRE = BLOCKS.registerBlock("oak_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> OAK_SOUL_CAMPFIRE = BLOCKS.registerBlock("oak_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> MANGROVE_SOUL_CAMPFIRE = BLOCKS.registerBlock("mangrove_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> SPRUCE_CAMPFIRE = BLOCKS.registerBlock("spruce_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> SPRUCE_SOUL_CAMPFIRE = BLOCKS.registerBlock("spruce_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> WARPED_CAMPFIRE = BLOCKS.registerBlock("warped_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> WARPED_SOUL_CAMPFIRE = BLOCKS.registerBlock("warped_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> PETRIFIED_CAMPFIRE = BLOCKS.registerBlock("petrified_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> PETRIFIED_SOUL_CAMPFIRE = BLOCKS.registerBlock("petrified_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> SCRAPWOOD_CAMPFIRE = BLOCKS.registerBlock("scrapwood_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> SCRAPWOOD_SOUL_CAMPFIRE = BLOCKS.registerBlock("scrapwood_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> BONE_CAMPFIRE = BLOCKS.registerBlock("bone_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> BONE_SOUL_CAMPFIRE = BLOCKS.registerBlock("bone_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> SHADE_CAMPFIRE = BLOCKS.registerBlock("shade_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.CAMPFIRE));
    public static final DeferredHolder<Block, CampfireBlock> SHADE_SOUL_CAMPFIRE = BLOCKS.registerBlock("shade_soul_campfire", props -> new CampfireBlock(true, 1, props), Block.Properties.ofFullCopy(Blocks.SOUL_CAMPFIRE));
