...
public class ItemInit
{
    ...
    //public static final DeferredHolder<Item, Item> COPPER_LEGGINGS = ITEMS.registerItem("copper_leggings", props -> new ArmorItem(ModArmorMaterials.COPPER, ArmorType.LEGGINGS, props), new Item.Properties());
    //public static final DeferredHolder<Item, Item> COPPER_BOOTS = ITEMS.registerItem("copper_boots", props -> new ArmorItem(ModArmorMaterials.COPPER, ArmorType.BOOTS, props), new Item.Properties());
