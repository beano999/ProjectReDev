...
public class FeatureInit
{
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> HADALITE_LAYER_FEATURE = FEATURES.register("hadalite", () -> new HadaliteLayerFeature(NoneFeatureConfiguration.CODEC));
}
